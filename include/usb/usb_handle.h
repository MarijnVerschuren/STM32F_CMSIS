...
typedef struct {
	/*!< init */
	void (*init)		();					// TODO: init
	void (*de_init)		();					// TODO: init
	/*!< control */
	void (*setup)		();					// TODO: init
	void (*IEP0_sent)	();					// TODO: needed??
	void (*OEP0_ready)	();					// TODO: needed??
	/*!< usage */
	void (*data_in)		(uint8_t epnum);	// TODO: init
	void (*data_out)	(uint8_t epnum);	// TODO: init
	void (*SOF)			();					// TODO: needed??

	/*!< USB_handle / config */
	void*				USB_handle;							// USB_handle_t*
	uint8_t				iep_num;
	uint8_t				oep_num;
